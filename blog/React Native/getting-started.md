...
![](/blog/React Native/img/react-native-sorry-not-supported.png)
...
![custom installation](/blog/React Native/img/react-native-android-studio-custom-install.png)

- 勾选`Performance`和`Android Virtual Device`

![additional installs](/blog/React Native/img/react-native-android-studio-additional-installs.png)

- 安装完成后，在Android Studio的启动欢迎界面中选择`Configure | SDK Manager`。

![configure sdk](/blog/React Native/img/react-native-android-studio-configure-sdk.png)
...
![platforms](/blog/React Native/img/react-native-android-studio-android-sdk-platforms.png)

- 在`SDK Tools`窗口中，选择`Show Package Details`，然后在`Android SDK Build Tools`中勾选`Android SDK Build-Tools 23.0.1`。（必须是这个版本）

![build tools](/blog/React Native/img/react-native-android-studio-android-sdk-build-tools.png)
...
![avd](/blog/React Native/img/react-native-android-studio-avd.png)
...
![custom installation](/blog/React Native/img/react-native-android-studio-custom-install-linux.png)

- 选择`Android Virtual Device`

![additional installs](/blog/React Native/img/react-native-android-studio-additional-installs-linux.png)
...
![custom installation](/blog/React Native/img/react-native-android-studio-custom-install-windows.png)

- 检查已安装的组件，尤其是模拟器和HAXM加速驱动。

![verify installs](/blog/React Native/img/react-native-android-studio-verify-installs-windows.png)
...
![configure sdk](/blog/React Native/img/react-native-android-studio-configure-sdk-linux.png)

</div><div markdown class="md-block windows android">

![configure sdk](/blog/React Native/img/react-native-android-studio-configure-sdk-windows.png)
...
![platforms](/blog/React Native/img/react-native-android-studio-android-sdk-platforms-linux.png)

</div><div markdown class="md-block windows android">

![platforms](/blog/React Native/img/react-native-android-studio-android-sdk-platforms-windows.png)
...
![build tools](/blog/React Native/img/react-native-android-studio-android-sdk-build-tools-linux.png)

</div><div markdown class="md-block windows android">

![build tools](/blog/React Native/img/react-native-android-studio-android-sdk-build-tools-windows.png)
...
![env variable](/blog/React Native/img/react-native-android-sdk-environment-variable-windows.png)
...
![accelerator](/blog/React Native/img/react-native-android-studio-kvm-linux.png)
...
![env variable](/blog/React Native/img/react-native-android-tools-environment-variable-windows.png)
...
![](/blog/React Native/img/react-native-congratulations.png)
