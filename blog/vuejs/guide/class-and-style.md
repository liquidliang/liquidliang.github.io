...
```
渲染的结果和上面一样。我们也可以在这里绑定返回对象的[计算属性](#!/blog%2Fvuejs/guide/computed.md)。这是一个常用且强大的模式：
...
> 这个章节假设你已经对 [Vue 组件](#!/blog%2Fvuejs/guide/components.md) 有一定的了解。当然你也可以跳过这里，稍后再回过头来看。
