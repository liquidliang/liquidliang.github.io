...
- **参考** [自定义选项的混合策略](https://cn.vuejs.org/v2/guide/mixins.html#Custom-Option-Merge-Strategies)
...
- **参考：** [异步更新队列](https://cn.vuejs.org/v2/guide/reactivity.html#Async-Update-Queue)
...
- **参考：** [全局混合](https://cn.vuejs.org/v2/guide/mixins.html#Global-Mixin)
...
- **参考：** [Render 函数](https://cn.vuejs.org/v2/guide/render-function.html)
...
- **参考:** [方法与事件处理器](https://cn.vuejs.org/v2/guide/events.html)
...
- **参考：** [生命周期图示](https://cn.vuejs.org/v2/guide/instance.html#Lifecycle-Diagram)
...
- **参考：**
  - [生命周期图示](https://cn.vuejs.org/v2/guide/instance.html#Lifecycle-Diagram)
  - [内容分发](https://cn.vuejs.org/v2/guide/components.html#Content-Distribution-with-Slots)
...
### render
  ...
  - **参考：**
    - [Render 函数](https://cn.vuejs.org/v2/guide/render-function.html)
...
- **参考：**
  ...
  - [资源命名约定](https://cn.vuejs.org/v2/guide/components.html#Assets-Naming-Convention)
...
- **参考：
** [函数式组件](https://cn.vuejs.org/v2/guide/render-function.html#Functional-Components)
...
- **详细:**
  ...
  用来访问被 [slot 分发](https://cn.vuejs.org/v2/guide/components.html#Content-Distribution-with-Slots)的内容。每个[具名 slot](https://cn.vuejs.org/v2/guide/components.html#Named-Slots) 有其相应的属性（例如：`slot="foo"` 中的内容将会在 `vm.$slots.foo` 中被找到）。`default` 属性包括了所有没有被包含在具名 slot 中的节点。

  在使用 [render 函数](https://cn.vuejs.org/v2/guide/render-function.html)书写一个组件时，访问 `vm.$slots` 最有帮助。
...
- **参考：**
  - [`<slot>` 组件](#slot-1)
  - [使用 Slots 进行内容分发](https://cn.vuejs.org/v2/guide/components.html#Content-Distribution-with-Slots)
  - [Render 函数](https://cn.vuejs.org/v2/guide/render-function.html#Slots)
...
- **详细：**
  ...
  Used to programmatically access [scoped slots](https://cn.vuejs.org/v2/guide/components.html#Scoped-Slots). For each slot, including the `default` one, the object contains a corresponding function that returns VNodes.

  Accessing `vm.$scopedSlots` is most useful when writing a component with a [render function](https://cn.vuejs.org/v2/guide/render-function.html).
...
- **另见：**
  - [子组件引用](https://cn.vuejs.org/v2/guide/components.html#Child-Component-Refs)
  - [ref](#ref)
...
- **参考：**
  ...
  - [异步更新队列](https://cn.vuejs.org/v2/guide/reactivity.html#Async-Update-Queue)
...
- **See also:** [Conditional Rendering - v-else-if](https://cn.vuejs.org/v2/guide/conditional.html#v-else-if)
...
- **参考：**
  - [方法与事件处理器](https://cn.vuejs.org/v2/guide/events.html)
  - [组件 - 自定义事件](https://cn.vuejs.org/v2/guide/components.html#Custom-Events)
...
- **参考：**
  ...
  - [组件 - 组件 Props](https://cn.vuejs.org/v2/guide/components.html#Props)
...
- **参考：**
  ...
  - [组件 - 在输入组件上使用自定义事件](https://cn.vuejs.org/v2/guide/components.html#Form-Input-Components-using-Custom-Events)
...
- **参考：**
  - [数据绑定语法- 插值](https://cn.vuejs.org/v2/guide/syntax.html#Text)
  - [组件 - 使用 v-once 实现轻量的静态组件](https://cn.vuejs.org/v2/guide/components.html#Cheap-Static-Components-with-v-once)
...
- **参考：** [子组件 Refs](https://cn.vuejs.org/v2/guide/components.html#Child-Component-Refs)
...
- **参考：** [命名 Slots](https://cn.vuejs.org/v2/guide/components.html#Named-Slots)
...
- **参考：** [使用Slots分发内容](https://cn.vuejs.org/v2/guide/components.html#使用Slots分发内容)
