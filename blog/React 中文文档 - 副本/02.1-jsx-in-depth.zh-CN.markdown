...
当显示名称没有定义时，JSX 会根据变量赋值来推断类的 [显示名称](http://reactjs.cn/react/docs/component-specs.html#displayname) :
...
> 注意:
>
> JSX 类似于 HTML，但不完全一样。参考 [JSX 陷阱](http://reactjs.cn/react/docs/jsx-gotchas-zh-CN.html) 了解主要不同。
